...
public class ElementRegistry {
    ...
    public static ChemicalElement add(int atomicNumber,String name,String abbreviation,Color color) {
        return add(atomicNumber,name,abbreviation,color,new String[]{"ingot"});
    }

    public static ChemicalElement add(int atomicNumber,String name,String abbreviation,Color color,String[] materials) {
    ...
    public static Set<Map.Entry<Integer,ChemicalElement>> get(String[] materials) {
        ...
        for(Integer key : keys()) {
            for(String material : materials) {
                ...
                if(element.materials.contains(material)) {
                    ret.put(key,element);
                }
            }
        }
